<?php
/**
 * 5th-Avenue fullwidth right sidebar layout
 *
 * @package 5th-Avenue
 * @version 1.0.0
...
?>
<section class="container-fluid page-layout page-layout--full-width page-layout--right-sidebar">
	<div class="row">
		<div class="col-md-<?php echo esc_attr( 12 - $sidebar_size ); ?>">
			<?php get_template_part( 'template-parts/' . $av5_post_type_path . '/' . $av5_singular, $post_format ); ?>
		</div>
		<div class="col-md-<?php echo esc_attr( $sidebar_size ); ?>">
