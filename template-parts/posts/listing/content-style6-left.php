<?php
/**
 * 5th-Avenue post layout on archive, style 6 left
 *
 * @package 5th-Avenue
 * @version 1.0.0
...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'row' ); ?>>
	<div class="content-style-6 content-position-left align-center">
		<div class="col-md-6 no-padding-mobile"><?php get_template_part( 'template-parts/posts/elements/image' ); ?></div>
		<div class="col-md-5 no-padding-mobile"><?php get_template_part( 'template-parts/posts/elements/categories' ); ?>		
