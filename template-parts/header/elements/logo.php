...
$logo_white			 = av5_get_option( 'website-white-logo', array( 'url' => '' ) );
$logo_retina_white	 = av5_get_option( 'website-white-retina-logo', array( 'url' => '' ) );
...
if ( ! empty( $logo_white['url'] ) && ( av5_get_option_meta( 'header-white-style', false ) || get_theme_mod( 'header_white-style', false ) ) ) {
	echo esc_attr( ' white-logo-on ' );
}
?><?php echo esc_attr( apply_filters( '5avenue_logo_class', 'flex-column logo' ) ); ?>">
	<a rel="home" href="<?php echo esc_url( $logo_url ); ?>">
		<?php if ( ! empty( $logo_white['url'] ) && ( av5_get_option_meta( 'header-white-style', false ) || get_theme_mod( 'header_white-style', false ) ) ) { ?>
			<img class="white-logo" src="<?php echo esc_attr( $logo_white['url'] ); ?>" alt="<?php echo esc_attr( $logo_name ); ?>" height="<?php echo esc_attr( $logo_white['height'] ); ?>" width="<?php echo esc_attr( $logo_white['width'] ); ?>" />
			<?php if ( ! empty( $logo_retina_white['url'] ) ) : ?>
				<img class="white-logo retina" src="<?php echo esc_attr( $logo_retina_white['url'] ); ?>" alt="<?php echo esc_attr( $logo_name ); ?>" height="<?php echo esc_attr( $logo_white['height'] ); ?>" width="<?php echo esc_attr( $logo_white['width'] ); ?>" style="height:<?php echo esc_attr( $logo_white['height'] ); ?>px; width:auto;" />
			<?php endif; ?>
		<?php } else { ?>
